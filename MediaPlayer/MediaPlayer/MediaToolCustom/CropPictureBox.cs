...
namespace System.Windows.Forms
{
    ...
    public class CropPictureBox : Panel
    {
        ...
        private Drawing.Point _mouseDownLocation = Drawing.Point.Empty;
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            if (_editing)
            {
                _mouseDownLocation = Drawing.Point.Empty;
        ...
        public Image GetCroppedImage()
        {
            ...
            if (SelectionInitialMode == CropBoxSelectionInitialMode.Square && SelectionResizeMode != CropBoxSelectionResizeMode.Unrestricted)
            {
                if (cropRectangle.Width != cropRectangle.Height)
                {
                    ...
                    Rectangle imageRectangle = new Rectangle(new Drawing.Point(0, 0), Image.Size);
        ...
        public Image GetCroppedImageThumbnail()
        {
            ...
            Drawing.Size thumbnailSize = new Drawing.Size();
            ...
            if (SelectionInitialMode == CropBoxSelectionInitialMode.Square && SelectionResizeMode != CropBoxSelectionResizeMode.Unrestricted)
            {
                ...
                {
                    //Fix rounding error to maintain square
                    int min = (int)Math.Min(thumbnailSize.Width, thumbnailSize.Height);
            ...
            else
            {
                ...
                switch (SelectionInitialMode)
                {
                    ...
                    case CropBoxSelectionInitialMode.Rectangle:
                        ...
                        {
                            rectangleSelectionRectangle.Size = new Drawing.Size(largerSize, minSize);

                            location = CalculateCorrectlyCenteredMargin(Image.Width, rectangleSelectionRectangle.Width);

                            rectangleSelectionRectangle.Location = new Drawing. Point(location, 0);
                        }
                        else
                        {
                            rectangleSelectionRectangle.Size = new Drawing.Size(minSize, largerSize);

                            location = CalculateCorrectlyCenteredMargin(Image.Height, rectangleSelectionRectangle.Height);

                            rectangleSelectionRectangle.Location = new Drawing.Point(0, location);
                        }
                    ...
                    case CropBoxSelectionInitialMode.Square:
                        ...
                        Rectangle squareSelectionRectangle = new Rectangle();

                        squareSelectionRectangle.Size = new Drawing.Size(minSize, minSize);

                        if (Image.Width > Image.Height)
                        {
                            location = CalculateCorrectlyCenteredMargin(Image.Width, squareSelectionRectangle.Width);

                            squareSelectionRectangle.Location = new Drawing.Point(location, 0);
                        }
                        else
                        {
                            location = CalculateCorrectlyCenteredMargin(Image.Height, squareSelectionRectangle.Height);

                            squareSelectionRectangle.Location = new Drawing.Point(0, location);
                        }
        ...
        {
            Drawing.Size newSize = new Drawing.Size(width, height);
            ...
            if (keepAspect)
            {
                ...
                newSize = new Drawing.Size(newWidth, newHeight);
            }
        ...
        private MouseMoveMode TranslateMouseLocation(Drawing.Point mouseLocation)
        {
        ...
        private void ValidateSelectionRectangle(ref Rectangle offsetSelection)
        {
            ...
            {
                if (SelectionResizeMode == CropBoxSelectionResizeMode.MaintainAspectRatio && _initialSelectionRectangle != null && SelectionInitialMode != CropBoxSelectionInitialMode.Custom)
                {
